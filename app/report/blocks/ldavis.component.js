System.register(['./data-component', 'angular2/core', '../services/global-color.service'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            LDAvisComponent = (function (_super) {
                __extends(LDAvisComponent, _super);
                function LDAvisComponent(globalColor) {
                    _super.call(this);
                    this.globalColor = globalColor;
                    $('.como-funciona').popover();
                }
                LDAvisComponent.prototype.setData = function (data) {
                    this.LDAvis($, '#lda', data, null, null, this.globalColor);
                };
                // ****************
                // HERE BE DRAGONS!
                // ****************
                LDAvisComponent.prototype.LDAvis = function ($, to_select, data, userBarChart, hoursChart, colors) {
                    ...
                    lambda = {
                        old: 0.8,
                        current: 0.8
                    }, color1 = colors.backgroundColor, // baseline color for default topic circles and overall term frequencies
                    color2 = colors.primaryColor; // 'highlight' color for selected topics and term-topic frequencies
                    ...
                    var margin = {
                        ...
                        bottom: 70,
                        left: 30
                    }, mdswidth = $('.container').width() / 2.5, mdsheight = mdswidth, barwidth = mdswidth, barheight = mdswidth, termwidth = 90, // width to add between two panels to display terms
                    ...
                    var base_opacity = 1, highlight_opacity = 1;
                    ...
                    */
                    ...
                    points.append("circle")
                        ...
                        state_save(true);
                        topic_on(this);
                        if (userBarChart && hoursChart) {
                            userBarChart.setTopic(vis_state.topic - 1);
                            hoursChart.setTopic(vis_state.topic - 1);
                        }
                    })
                    ...
                    d3.select("#bar-freqs").append("text")
                        ...
                        .text("Frecuencia global de palabras");
                    // create gradient
                    ...
                    gradient.append("svg:stop")
                        .attr("offset", "100%")
                        .attr("stop-color", 'rgba(213, 84, 226, 0.87)')
                        .attr("stop-opacity", 1);
                    d3.select("#bar-freqs").append("rect")
                        .attr("x", 0)
                    ...
                    d3.select("#bar-freqs").append("text")
                        ...
                        .style("dominant-baseline", "middle")
                        .text("Frecuencia de la palabra en el tema seleccionado");
                    ...
                    function init_forms(topicID, lambdaID, visID) {
                        ...
                        inputDiv.setAttribute("style", "display: none"); // to match the width of the main svg element
                    ...
                    function topic_on(circle) {
                        ...
                        // create gradient
                        var gradientRadial = svg.append("svg:defs")
                            ...
                            .attr("spreadMethod", "pad");
                        // Define the gradient colors
                        gradientRadial.append("svg:stop")
                            .attr("offset", "0%")
                            .attr("stop-color", 'rgba(213, 84, 226, 0.87)')
                            .attr("stop-opacity", 1);
                        gradientRadial.append("svg:stop")
                            ...
                            .attr("stop-color", colors.primaryColor)
                            .attr("stop-opacity", 1);
                        circle.style.fill = 'url(#gradientRadial)';
                    ...
                    function term_on(term) {
                        ...
                        d3.select(".circleGuideTitle")
                            .text("Distribución de temas para la palabra '" + term.innerHTML + "'");
                    }
                ...
                return LDAvisComponent;
            }(data_component_1.DataComponent));
            exports_1("LDAvisComponent", LDAvisComponent);
        }
    }
});
